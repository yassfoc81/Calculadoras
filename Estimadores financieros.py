...
raiz.title("Estimadores Financieros")
...
inflacion_imp = StringVar(value="0")
...
def reset(ventana):
    if ventana == "retiro":
      ...
      entry_M0_ren.config(state='normal')
      entry_m_ren.config(state='normal')
      entry_t_ren.config(state='normal')
      entry_R_ren.config(state='normal')
      ...
      # Desbloquea todas las entradas
      entry_M0_ahorro.config(state='normal')
      entry_m_ahorro.config(state='normal')
      entry_t_ahorro.config(state='normal')
      entry_Mf_ahorro.config(state='normal')
...
#-----------------Fila 1----------------------------------
label_gasto = Label(tab_retiro, text="Gasto mensuale estimado:", background=color0, font=("Arial", 13, "bold"))
